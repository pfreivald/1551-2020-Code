...
public class Control_Panel_Rotate_2 extends CommandBase {
   ...
   */
  public Control_Panel_Rotate_2(Control_Panel_Motor control_panel_motor) {
  ...
  @Override
  public void execute() {
    control_panel_motor.Rotate(Constants.ROTATE_SPEED *-1);
  }
  ...
  public boolean isFinished() {
    return joystick3.getRawButtonReleased(Constants.JOYSTICK3_BUTTON_8);
  }
}
